...
export const TaskPortal = () => {
  ...
  const [tasks, setTasks] = useState([
    ...
    { sno: 13, taskname: "Abc", submitted: "-", approved: "A", due: dueDate },
    { sno: 14, taskname: "Def", submitted: "S", approved: "-", due: dueDate },
    { sno: 15, taskname: "Abc", submitted: "-", approved: "-", due: dueDate },
  ]);
  ...
  return (
    <>
      <Header />
      <div className="max-w-7xl px-6 pt-16">
        <div className="flex justify-between items-center mb-6">
          ...
          <select onClick={(e)=>setFilter(e.target.value)} className="ml-4 py-2 px-4 border rounded-md shadow-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
            <option hidden value="">
              Filter
            </option>
              ...
              {filteredTasks.map((task) => (
                <tr key={task.sno} className="hover:bg-gray-50 transition-colors ">
                  ...
                  <td className="px-4 py-2 border  border-indigo-700 text-center">
                    <button className="text-indigo-5000 hover:underline">
                      View
                    </button>
                  </td>
                </tr>
