...
export const Dashboard = () => {
  ...
  const inactive = "flex mx-5 my-5 text-gray-400 font-medium fill-gray-400 dark:text-gray-500 dark:fill-gray-500";
  ...
  return (
    ...
    <aside className='flex flex-col py-5 px-4 w-[230px] bg-white dark:bg-gray-800 fixed left-0 top-0 h-full z-40 border-r border-gray-200 dark:border-gray-700'>
