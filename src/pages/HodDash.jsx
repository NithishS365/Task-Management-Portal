...
export const HodDash = () => {
  ...
  return (
    ...
    <aside className='flex flex-col py-5 px-2 w-[245px] bg-white dark:bg-gray-800 fixed left-0 top-0 h-full z-40 border-r border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-gray-900/50'>
            ...
            <div className='flex flex-col pt-8  w-64 font-Montserrat text-xl  '>
              ...
              <NavLink to='/HodDash/analytics' className={({isActive})=>isActive?active:inactive} ><svg xmlns="http://www.w3.org/2000/svg" height="27px" viewBox="0 -960 960 960" width="20px"><path d="M120-120v-720h720v720H120Zm80-80h560v-560H200v560Zm80-160h400v-80H280v80Zm0-160h400v-80H280v80Zm0-160h400v-80H280v80Z"/></svg>Staff Analysis</NavLink>
            ...
            <button className='mt-auto  p-3 ml-8 font-bold text-red-600 dark:text-red-400 flex gap-2 items-center w-32 rounded-lg hover:bg-red-500 hover:text-white hover:fill-white dark:hover:bg-red-900/30 transition-colors border border-red-200 dark:border-red-800' onClick={takemeout}> 
              <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" className="fill-red-600 dark:fill-red-400 hover:fill-white">
