...
export const HodDash = () => {
  ...
  const inactive = "flex mx-5 my-5 text-gray-400 font-medium fill-gray-400 dark:text-gray-400 dark:fill-gray-400";
  const active = "flex mx-5 my-5 text-indigo-500 font-bold fill-indigo-700 dark:text-indigo-400 dark:fill-indigo-400 border border-t-0 border-b-0 border-l-0 border-r-3 ";
  

  return (
    <>
    <div className='flex h-screen overflow-hidden'>
    <aside className='flex flex-col py-5 px-2 w-[245px] bg-white dark:bg-gray-800 fixed left-0 top-0 h-full z-40 border-r border-gray-200 dark:border-gray-700'>
            <Link to="/" className='flex justify-center items-center' >
            <img src={logo} width={40} />
            <h1 className='text text-4xl font-mono font-bold dark:text-gray-200'>TaskRise</h1>
            </Link>
            ...
            <button className='mt-auto p-2 ml-12 font-bold text-red-500 flex gap-1  w-28 rounded-lg hover:bg-red-200 dark:text-red-400 dark:hover:bg-red-900/50' onClick={takemeout}> <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className="fill-red-700 dark:fill-red-500"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg>Logout</button>
